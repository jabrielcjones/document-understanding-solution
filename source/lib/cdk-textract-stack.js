...
class CdkTextractStack extends cdk.Stack {
    ...
    constructor(scope, id, props) {
        ...
        const bulkProcessingBucket = new s3.Bucket(this, this.resourceName("BulkProcessingBucket"), {
            ...
            lifecycleRules: [
                {
                    expiration: core_1.Duration.days(3),
                },
            ],
        });
        // ### Client ###
        ...
        securityGroup.addIngressRule(aws_ec2_1.Peer.anyIpv4(), aws_ec2_1.Port.allTraffic(), "allow lambda ingress", false);
        const esSearchLogGroup = new aws_logs_1.LogGroup(this, this.resourceName("ElasticSearchSearchLogGroup"), {
            logGroupName: this.resourceName("ElasticSearchSearchLogGroup"),
        });
        const esIndexLogGroup = new aws_logs_1.LogGroup(this, this.resourceName("ElasticSearchIndexLogGroup"), {
        ...
        documentBulkProcessor.addEventSource(new aws_lambda_event_sources_1.SqsEventSource(documentBulkProcessingQueue, {
            batchSize: 5,
        }));
        ...
        const DUSApiLogGroup = new aws_logs_1.LogGroup(this, this.resourceName("DUSApiLogGroup"), {
        ...
        const api = new apigateway.LambdaRestApi(this, this.resourceName("DUSAPI"), {
            ...
            deployOptions: {
                ...
                accessLogDestination: new aws_apigateway_1.LogGroupLogDestination(DUSApiLogGroup),
        ...
        const cfnBucket = logsS3Bucket.node.defaultChild;
    ...
    createandGetKendraRelatedResources(boto3Layer, logsS3Bucket, documentsS3Bucket, samplesS3Bucket, bulkProcessingBucket) {
        var _a;
        ...
        (_a = kendraRole.assumeRolePolicy) === null || _a === void 0 ? void 0 : _a.addStatements(new iam.PolicyStatement({
            effect: iam.Effect.ALLOW,
        ...
        onEventKendraIndexLambda.addToRolePolicy(new iam.PolicyStatement({
            effect: iam.Effect.ALLOW,
            actions: ["kendra:CreateIndex", "kendra:TagResource"],
            resources: ["*"],
        }));
        onEventKendraIndexLambda.addToRolePolicy(new iam.PolicyStatement({
            effect: iam.Effect.ALLOW,
        ...
        isCompleteKendraIndexLambda.addToRolePolicy(new iam.PolicyStatement({
            effect: iam.Effect.ALLOW,
        ...
        const kendraIndexCustomResource = new core_1.CustomResource(this, this.resourceName("kendraIndexCustomResource"), {
        ...
        onEventKendraDataSourceLambda.addToRolePolicy(new iam.PolicyStatement({
            effect: iam.Effect.ALLOW,
            actions: [
        ...
        const kendraIndexId = kendraIndexCustomResource
            .getAtt("KendraIndexId")
            .toString();
        const kendraDataSourceCustomResource = new core_1.CustomResource(this, this.resourceName("kendraDataSourceCustomResource"), {
